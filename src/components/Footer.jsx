...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#93a969] text-white">
      <div
        className={`mx-auto max-w-7xl px-6 py-10 flex flex-col gap-10 md:flex-row md:items-center md:justify-between
      ...
      >
        ...
        {/* Links */}
        <div className="flex flex-col sm:flex-row gap-10 text-sm justify-center">
          <div>
            <p className="font-semibold mb-4"> {t("Footer.linkTitle")} </p>
            <ul className="space-y-2 opacity-80">
              <li><Link to="/">{t("Footer.link1")}</Link></li>
              <li><Link to="/about-us">{t("Footer.link2")}</Link></li>
              <li><Link to="/services">{t("Footer.link3")}</Link></li>
              <li><Link to="/contact">{t("Footer.link4")}</Link></li>
              
            </ul>
          </div>
        
          <div>
            <p className="font-semibold mb-4">{t("Footer.servicesTitle")} </p>
            <ul className="space-y-2 opacity-80">
              <li>{t("Footer.ser1")} </li>
              <li> {t("Footer.ser2")}</li>
              <li>{t("Footer.ser3")}</li>
...
<div class="flex items-center gap-4">
  ...
  <div class="social-button">
    <button class="relative w-10 h-10 rounded-full group">
      ...
      {/* Bottom */}
      <div className="border-t border-white/20 text-center text-xs py-4 opacity-60">
        © 2026 Rock Power. All rights reserved.
      </div>
    </footer>
  );
};
